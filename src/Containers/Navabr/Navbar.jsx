                ...
                <nav class="navbar navbar-expand-lg navbar-light row d-flex flex-column">
                    ...
                    <div class="collapse navbar-collapse row px-5 py-1" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            ...
                            <li>
                                <div>
                                    ...
                                    <div className='expand-nav  d-none flex-column'>
                                        ...
                                        <a class="" href="/Registration_Direct_Income"><BsArrowRightShort /> Registration Direct Income</a>
                                        <a class="" href="/Activation_Direct_Income"><BsArrowRightShort /> Activation Direct Income</a>
                            ...
                            <li>
                                <button className='btn1 '><FaLock className="me-1 mb-1 " /> Logout</button>
                            </li>
                        </ul>
                    </div>
